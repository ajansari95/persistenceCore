...
import (
	...
	app "github.com/persistenceOne/persistenceCore/v3/app"
)
...
func (v *validator) signMsg(msgs ...sdk.Msg) (*sdktx.Tx, error) {
	txBuilder := encodingConfig.TransactionConfig.NewTxBuilder()
	...
	bytesToSign, err := encodingConfig.TransactionConfig.SignModeHandler().GetSignBytes(
	...
	bz, err := encodingConfig.TransactionConfig.TxEncoder()(signedTx)
	if err != nil {
		return nil, err
	}
