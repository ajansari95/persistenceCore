...
key_name = 'val01-persistenceCore-a'
store_prefix = 'ibc'
max_gas = 6000000
...
rpc_timeout = '10s'
account_prefix = 'persistence'
key_name = 'val01-persistenceCore-b'
store_prefix = 'ibc'
max_gas = 6000000
gas_price = { price = 0.001, denom = 'photon' }
gas_adjustment = 1.0
...
# import keys
hermes keys restore ${PSTAKE_B_E2E_CHAIN_ID} -n "val01-persistenceCore-b" -m "${PSTAKE_B_E2E_VAL_MNEMONIC}" -p "m/44'/750'/0'/0/0"
hermes keys restore ${PSTAKE_A_E2E_CHAIN_ID} -n "val01-persistenceCore-a" -m "${PSTAKE_A_E2E_VAL_MNEMONIC}" -p "m/44'/750'/0'/0/0"
